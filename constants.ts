...
export const I18N: Translation = {
  ...
  studio: { en: 'Style Studio' },
  gallery: { en: 'My Heritage' },
  about: { en: 'About Us' },
  partners: { en: 'Partners' },
  subscription: { en: 'For Artisans' },
  security: { en: 'Security' },
  styling: { en: 'Styling' },
  upload_photo: { en: 'Upload Photo' },
  take_photo: { en: 'Use Camera' },
  calibrate: { en: 'Calibrate Body Points' },
  select_garment: { en: 'Select Garment' },
  generate: { en: 'Weave Magic' },
  generating: { en: 'Weaving...' },
  mission_stat: { en: 'Preserving Heritage across 69 Wilayas' },
  sec_title: { en: 'Guarantees & Security' },
  sec_subtitle: { en: 'Your trust is our priority' },
  sec_photo_title: { en: 'Photo Security' },
  sec_photo_1: { en: '256-bit SSL Encryption' },
  sec_photo_2: { en: 'Auto-delete after 24h' },
  sec_photo_3: { en: 'Never sold or shared' },
  sec_photo_4: { en: 'GDPR Compliant' },
  sec_privacy_title: { en: 'Privacy' },
  sec_privacy_1: { en: 'Personal data anonymized' },
  sec_privacy_2: { en: 'No tracking' },
  sec_privacy_3: { en: 'Explicit consent' },
  sec_privacy_4: { en: 'Right to be forgotten enabled' },
  sec_return_title: { en: 'Free Returns' },
  sec_return_1: { en: '30 days, fees covered' },
  sec_return_2: { en: 'Refund within 7 days' },
  sec_return_3: { en: 'Shipping insurance' },
  sec_return_4: { en: '24/7 Customer Support' },
  modern_collection: { en: "Modern Women's Sets" },
  my_heritage: { en: "My Heritage" },
};
