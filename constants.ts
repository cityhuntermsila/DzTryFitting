...
export const GARMENTS: Garment[] = [
  ...
  // --- DZIRI (Algiers Modern) ---
  {
    ...
    price: '120,000 DZD',
    description: 'One-piece sleeveless ensemble in silk satin, often worn with a light Bolero.',
    material: 'Silk Satin & Fetla',
    colors: ['#ffffff', '#f3f4f6'],
    sizes: ['36', '38', '40']
  },
  {
...
export const PARTNERS = [
  ...
  { name: 'Heritage Algiers', logo: 'images/partners/heritage_algiers.png' },
  { name: 'Kabylia Arts', logo: 'images/partners/kabylia_arts.png' },
  { name: 'Sahara Weaves', logo: 'images/partners/sahara_weaves.png' },
  { name: 'Golden Needle', logo: 'images/partners/golden_needle.png' },
  { name: 'El Bahdja Silk', logo: 'images/partners/el_bahdja.png' },
  { name: 'Aurès Traditions', logo: 'images/partners/aures_traditions.png' },
  { name: 'Zibans Jewelry', logo: 'images/partners/zibans_jewelry.png' },
  { name: 'Tassili Leather', logo: 'images/partners/tassili_leather.png' },
  { name: 'Hoggar Silver', logo: 'images/partners/hoggar_silver.png' },
];

// Gallery items will now use garment images for consistency
const GARMENT_IMAGES = GARMENTS.map(g => g.image);
...
export const GALLERY_ITEMS: GalleryItem[] = PARTNERS.flatMap((partner, index) => {
  ...
  const imgIndex1 = index % GARMENT_IMAGES.length;
  const imgIndex2 = (index + 1) % GARMENT_IMAGES.length;
  ...
  return [
    {
      ...
      image: GARMENT_IMAGES[imgIndex1],
      secondaryImage: GARMENT_IMAGES[imgIndex2],
      date: '2 days ago',
      likes: 120 + index * 5,
    ...
    },
    {
      ...
      partnerLogo: partner.logo,
      category: 'Vintage',
      image: GARMENT_IMAGES[(GARMENT_IMAGES.length - 1 - index) % GARMENT_IMAGES.length],
      secondaryImage: GARMENT_IMAGES[(index + 2) % GARMENT_IMAGES.length],
      date: '1 week ago',
      likes: 85 + index * 3,
