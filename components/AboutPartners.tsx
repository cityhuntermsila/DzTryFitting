            ...
            if (actionType === 'collection') {
                ...
                return (
                    <div className="max-w-7xl mx-auto p-4 md:p-8 animate-fade-in">
                        ...
                        {/* Product Detail Modal - Synchronized with Gallery */}
                        {selectedItem && (
                            <div className="fixed inset-0 z-[60] flex items-start justify-center p-4 md:p-8 animate-fade-in">
                                ...
                                >
                                    ...
                                    <div className="w-full md:w-1/2 h-[40vh] md:h-full bg-gray-50 flex items-center justify-center relative overflow-hidden group/modal-img">
                                        <img src={activeImage || selectedItem.image} alt={selectedItem.title} className="w-full h-full object-cover md:object-contain bg-white" />
                                    ...
                                    <div className="w-full md:w-1/2 p-6 md:p-12 overflow-y-auto">
                                        <div className="w-full flex flex-col h-full">
                                            ...
                                            <div className="prose prose-lg text-gray-600 mb-4 leading-relaxed font-light">
